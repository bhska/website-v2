...
export const Cross = () => (
  <div className="relative h-6 w-6">
    ...
    <div className="bg-background absolute right-3 h-6 w-px" />
    <div className="bg-background absolute top-3 h-px w-6" />
    <div className="bg-background absolute bottom-3 h-px w-6" />
...
export const Section = ({ children, className, ...props }: SectionProps) => (
  <section {...props}>
    <div className="relative container mx-auto max-w-5xl">
      ...
      <div className="absolute -right-3 -bottom-3 z-10 hidden h-6 sm:block">
        <Cross />
      </div>
    </div>
  </section>
